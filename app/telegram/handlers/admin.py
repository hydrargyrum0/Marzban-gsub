...
from app.gdrive.updater import process_users
...
@bot.message_handler(commands=['update_subs'], is_admin=True)
def update_subs_command(message: types.Message):
    try:
        process_users()
        bot.reply_to(message, "✅ Subscription updates processed successfully.")
    except Exception as e:
        bot.reply_to(message, f"❌ An error occurred while processing subscription updates: {str(e)}")
